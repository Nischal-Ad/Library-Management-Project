...
<body>
    ...
    <div class="bgimage">
        <div class="menu">
            ...
            <div class="leftmenu">
                <h4> <img src="images/logo3.PNG" alt="logo"> </h4>
            </div>
        </div>
        ...
        <div class="text bg-dark container opacity">
            ...
            <button id="buttonone" type="button" class="" data-toggle="modal" data-target="#myModal">
                Login
            </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="Students/loginCheck">
